...
ALTER TABLE menyewa
CHANGE denda tot_hrg INT;

ALTER TABLE menyewa
CHANGE tot_hrg denda INT;
...
INSERT INTO menyewa VALUES ('S0001','001','01/01/2007','2','02/01/2007','0','6000')
...
UPDATE menyewa SET tot_harga = '60000' WHERE tot_hrg = '6000'
UPDATE menyewa SET tot_harga = '35000' WHERE tot_hrg = '3500'
UPDATE menyewa SET tot_harga = '95000' WHERE tot_hrg = '9500'
